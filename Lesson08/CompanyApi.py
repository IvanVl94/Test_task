...
class CompanyApi:
    ...
    def get_company_list(self , params_tu_add = None):
        resp = requests.get(self.url+'/company', params=params_tu_add)
        return resp.json()
    ...
    def cread_company(self , name, description = ""):
        company = {
            "name" : name,
    ...
    def delete(self, id):
        ...
        resp = requests.patch(self.url+'/company/delete/' + str(id), headers=my_headers)
        return resp.json()
